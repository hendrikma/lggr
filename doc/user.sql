...
GRANT SELECT,UPDATE,DELETE ON DB_NAME.* TO USER_LOGGERADMIN@DB_IP IDENTIFIED BY 'PW_LOGGERADMIN';
GRANT SELECT,INSERT  ON TABLE `DB_NAME`.`servers` TO 'USER_LOGGERADMIN'@'DB_IP';
